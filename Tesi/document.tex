...
\begin{document}
	...
	\begin{itemize}
		...
		I pazienti usufruiscono di questi contenuti mediante il vr, in modo da poter visionare i contenuti scelti.
			\begin{figure}[h]
				...
				\label{fig:luminopia}
			\end{figure}
	    \item Esiste poi un altro tipo di tecnologia, I-BiT Plus\cite{I-Bit}s, il quale permette al paziente di intrattenersi mediante giochi interattivi o video.
  ...
  \end{figure}
    ...
    In fine per chiudere il discorso cardboard, andrò a parlare della limitazione che influisce maggiorante sull'immersività del gioco, ovvero la limitazione dei gradi di libertà dell'oggetto \text{Testa}, il quale è responsabile di orientare le due telecamere.
